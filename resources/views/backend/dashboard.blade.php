...
@section('footer_links')
    ...
    <script src="{{ asset('backend/dashtrap/assets/libs/morris.js/morris.min.js') }}"></script>

    <script src="{{ asset('backend/dashtrap/assets/libs/raphael/raphael.min.js') }}"></script>

    <!-- Dashboard init-->
    <script src="{{ asset('backend/dashtrap/assets/js/pages/dashboard.js') }}"></script>
@endsection
