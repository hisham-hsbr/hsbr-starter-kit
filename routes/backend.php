...
Route::middleware('auth')->middleware(['auth', 'verified'])->group(function () {
    ...
    Route::controller('App\Http\Controllers\AppControllers\TestDemoController')->prefix('/admin/test/demos')->name('test.demos.')->group(function () {
        ...
        Route::delete('/force-destroy/{id}', action: 'forceDestroy')->name('force.destroy'); //->middleware('permission:Test Demo Read');
    ...
    Route::controller('App\Http\Controllers\AppControllers\SettingsController')->prefix('/admin/user-management/settings')->name('settings.')->group(function () {
        ...
        Route::get('/general-settings', 'generalSettings')->name('general.settings'); //->middleware('permission:Model Settings Read');
        Route::patch('/general-settings/update', 'generalSettingsUpdate')->name('general.settings.update'); //->middleware('permission:Settings Read');
